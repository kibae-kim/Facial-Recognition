...
public class EigenFaceDetector extends FaceDetectorBase {
    ...
    public EigenFaceDetector(int w, int h, int k) { super(w, h); this.k = k; }
    ...
    @Override public void train(List<Mat> imgs, int[] labels) {
        ...
        projections=new Mat(); Core.PCAProject(X,mean,eigVec,projections);
    ...
    @Override public int predict(Mat gray) {
        ...
        Mat y = new Mat(); Core.PCAProject(x,mean,eigVec,y);
